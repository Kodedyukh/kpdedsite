...
var PlayScene = exports.PlayScene = function (_Phaser$Scene) {
    ...
    _createClass(PlayScene, [{
        ...
        value: function create() {
            ...
            this.winPopupImage = this.add.image(gameWidth * 0.5, gameHeight * 0.35, 'winPopupImage');
            this.nextLevelButton = this.makeButton('nextLevelButton', '', gameWidth * 0.5 + 80, gameHeight * 0.65, this.launchNextLevel);            
            this.replayButton = this.makeButton('replayButton', '', gameWidth * 0.5 - 80, gameHeight * 0.65, this.replayLevel);
            this.moreGamesButton = this.makeButton('moreGamesButton', '', gameWidth * 0.5, gameHeight * 0.85, this.showMoreGames);
            ...
            this.winPopup.add(this.moreGamesButton);
            ...
            this.moreGamesButton.disableInteractive();
            ...
            this.finalPopupImage = this.add.image(gameWidth*0.5, gameHeight*0.35, 'finalPopupImage');
            this.finalPopupImage.setScale(0.9);
            this.finalGoLevelChoiceButton = this.makeButton('goLevelChoiceButton', '', gameWidth*0.5 - 80, gameHeight*0.72, this.goLevelChoice);
            this.finalReplayButton = this.makeButton('replayButton', '', gameWidth*0.5 + 80, gameHeight*0.72, this.replayLevel);
            this.moreGamesFinalButton = this.makeButton('moreGamesButton', '', gameWidth * 0.5, gameHeight * 0.87, this.showMoreGames);
            ...
            this.finalPopup.add(this.moreGamesFinalButton);
            ...
            this.moreGamesFinalButton.disableInteractive();
            ...
            GameAnalytics("addProgressionEvent", "Start", levelName);
        ...
        value: function showFinalPopup() {
            if (this.finalPopup.alpha === 0)
            {
                ...
                this.moreGamesFinalButton.setInteractive();
                this.freezed = true;
        ...
        key: 'showMoreGames',
        value: function showMoreGames() {
            window.open("https://kpded.com", "_blank");
        }
    }, {
        key: 'showWinPopup',
        value: function showWinPopup() {
            if (this.winPopup.alpha === 0) {
                GameAnalytics("addProgressionEvent", "Complete", 'level'+this.game.levelNumber);
                this.winSound.play();
                this.winPopup.alpha = 1;
                this.nextLevelButton.setInteractive();
                this.replayButton.setInteractive();
                this.moreGamesButton.setInteractive();
                this.freezed = true;
                this.pauseButton.disableInteractive();
            }
        }
        ...
        value: function showLosePopup(animation, frame) {
            if (animation.key === 'shock' && this.losePopup.alpha === 0) {
                GameAnalytics("addProgressionEvent", "Fail", 'level'+this.game.levelNumber);
                this.loseSound.play();
...
var PreloaderScene = exports.PreloaderScene = function (_Phaser$Scene) {
    ...
    _createClass(PreloaderScene, [{
        ...
        value: function preload() {
            ...
            this.splashScreen = this.add.image(gameWidth*0.5, gameHeight*0.5, 'splashScreen');
            this.splashScreen.setScale(0.8);

            this.splashTween = this.tweens.add({
                targets: this.splashScreen,
                props: {
                    scaleX: {value: 1, ease: 'Linear'},
                    scaleY: {value: 1, ease: 'Linear'}
                },
                duration: 1500
            });

            this.splashTween.setCallback('onComplete', function(){                
                var alphaTween = this.tweens.add({
                    targets: this.splashScreen,
                    props: {
                        alpha: {value: 0.2, ease: 'Linear'}
                    },
                    duration: 400
                });
            }, [], this);

            this.cameras.main.setBackgroundColor('#2a3343');

            this.time.delayedCall(2000, function(){
                this.splashScreen.alpha = 0;
                this.cameras.main.setBackgroundColor('#3d3752');
            }, [], this);
            ...
            this.load.atlas('moreGamesButton', 'assets/moreGamesButton.png', 'assets/moreGamesButton.json');
...
var BootScene = exports.BootScene = function (_Phaser$Scene) {
    ...
    _createClass(BootScene, [{
        ...
        value: function preload() {
            ...
            this.load.image('splashScreen', 'assets/splash.png');
        }
    }, {
        key: 'create',
        value: function create() {
