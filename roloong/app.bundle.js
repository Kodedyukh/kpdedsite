...
var PreloaderScene = exports.PreloaderScene = function (_Phaser$Scene) {
    ...
    _createClass(PreloaderScene, [{
        ...
        value: function preload() {
            ...
            this.add.image(gameWidth / 2 - 151, 480, 'preloaderBack').setOrigin(0, 0.5);

            this.preloaderBar = this.add.image(gameWidth / 2 - 150, 480, 'preloaderBar').setOrigin(0, 0.5);
...
var MainMenuScene = exports.MainMenuScene = function (_Phaser$Scene) {
    ...
    _createClass(MainMenuScene, [{
        ...
        value: function create() {
            ...
            this.credits = this.add.image(gameWidth * 0.01, gameHeight * 0.99, 'credits');
        ...
        value: function scaleAndPositionUI() {
            ...
            this.credits.setPosition(gameWidth * 0.01, gameHeight * 0.99);
...
var PlainCollider = __webpack_require__(246);
...
var PlayScene = exports.PlayScene = function (_Phaser$Scene) {
    ...
    _createClass(PlayScene, [{
        ...
        value: function create() {
            ...
            // mobile buttons
            if (!this.game.device.os.desktop) {
                this.turnLeftButton = this.makeButton(10 + 10000, gameHeight - 10 + 10000, 'turnLeftButton', '', this.rotateMaze, 'left');
                this.turnLeftButton.setOrigin(0, 1);

                this.turnRightButton = this.makeButton(gameWidth - 10 + 10000, gameHeight - 10 + 10000, 'turnRightButton', '', this.rotateMaze, 'right');
            ...
            this.uKey.on('down', function () {
                if (this.playing) this.undoLastMove();
            }, this);

            this.leftKey.on('down', function () {
                if (this.playing) this.rotateMaze('left');
            }, this);

            this.rightKey.on('down', function () {
                if (this.playing) this.rotateMaze('right');
            }, this);
...
function detectMob() {
    if (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i) || window.innerWidth <= 800 && window.innerHeight <= 600) {
        return true;
    } else {
        return false;
    }
